            ...
            <div className="">
              {isLoading ? (
                ...
                <TableBody>
                  ...
                  {filteredData.slice(2).map((user) => (
                    <TableRow key={user.id} className="blur-sm">
                      <TableCell>
                        <div className="font-medium">Blurred Name</div>
                      </TableCell>
                      <TableCell>
                        <Badge variant="secondary">Blurred</Badge>
                      </TableCell>
                      <TableCell>Blurred</TableCell>
                      <TableCell>Blurred</TableCell>
                      <TableCell>Blurred Info</TableCell>
                      <TableCell>
                        <div className="flex gap-2">
                          <Button
                            variant="outline"
