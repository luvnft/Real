...
export default function UserForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { data, error } = await supabase
      .from(tableName)
      .update({ ...formData, userid: user.id });
  ...
  const renderFormFields = () => {
    const fields = {
      seller: [
        ...
        { name: 'numberOfProperties', label: 'Number of Properties Selling', type: 'number' },
        { name: 'minimumPrice', label: 'Minimum Selling Price', type: 'number' },
        { name: 'maximumPrice', label: 'Maximum Selling Price', type: 'number' },
        ...
        { name: 'propertyDescription', label: 'Property Description', type: 'textarea' },
      ...
      buyer: [
        ...
        { name: 'minSquareFootage', label: 'Minimum Square Footage', type: 'number' },
        { name: 'additionalRequirements', label: 'Additional Requirements', type: 'textarea' },
        { name: 'preApprovalStatus', label: 'Pre-approval Status', type: 'text' },
      ],
      agent: [
        { name: 'fullName', label: 'Full Name', type: 'text' },
        { name: 'email', label: 'Email', type: 'email' },
      ...
      landinspector: [
        ...
        { name: 'serviceAreas', label: 'Service Areas', type: 'text' },
        { name: 'inspectionTypes', label: 'Types of Inspections Offered', type: 'textarea' },
        { name: 'availabilitySchedule', label: 'Availability Schedule', type: 'textarea' },
      ],
    };
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle>{userRole.charAt(0).toUpperCase() + userRole.slice(1).replace('_', ' ')} Form</CardTitle>
